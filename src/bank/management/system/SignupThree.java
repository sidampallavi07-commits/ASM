...
public class SignupThree extends JFrame implements  ActionListener{
    ...
    SignupThree(String formno){
        ...
        i1.setFont(new Font("Ralewa",Font.BOLD, 22));
        i1.setBounds(280, 40, 400, 40);
        add(i1);
        
        JLabel type = new JLabel("Account Type:");
        type.setFont(new Font("Ralewa",Font.BOLD, 22));
        ...
        c7 = new JCheckBox("I hereby decleres that the above enterd details are correct to the best of my knowledge");
