...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        JLabel addionalDetails=new JLabel("Page 2: Additional Details");
        addionalDetails.setFont(new Font("Raleway",Font.BOLD,22));
        addionalDetails.setBounds(290, 80, 400, 30);
        add(addionalDetails);
        ...
        String incomecatogory[] = {"Null" , "< 1,50,0000" , "< 2,50,000" , "<5,00,000" , "upto 10,00,000"};
        ...
        eoccupation.setBounds(100, 390, 200, 30);
        add(eoccupation);
       ...
       ButtonGroup ecitizen =new ButtonGroup();
       ecitizen.add(syes);
       ecitizen.add(sno);
